<template lang="html">
  <div class="app-container">
      ...
      <el-table-column
        ...
        align="center">
          <el-button @click="handleClick(scope.row.link)" type="text" size="small">需求文档</el-button>
          <el-button @click="handleClick(scope.row.guide)" type="text" size="small">测试指引</el-button>
        </template>
      </el-table-column>
      ...
      <!-- <el-table-column
        ...
        <template slot-scope="scope"
        align="center">
          <el-button @click="handleClick(scope.row)" type="text" size="small">测试指引</el-button>
        </template>
      </el-table-column> -->
